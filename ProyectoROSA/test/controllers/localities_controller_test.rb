...
class LocalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post localities_url, params: { locality: { citys_id: @locality.citys_id, name: @locality.name } }, as: :json
    end
  ...
  test "should update locality" do
    patch locality_url(@locality), params: { locality: { citys_id: @locality.citys_id, name: @locality.name } }, as: :json
    assert_response 200
  end
